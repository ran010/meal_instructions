...
export default class extends Controller {
   ...
   * These elements are used to display the file in the command preview.
  ...
  removePreview(event) {
    ...
    let fileInput = document.getElementById("command_attachments");
  ...
  audio() {
    ...
    let commandAttachments = document.getElementById("command_attachments");
    ...
    if (navigator.mediaDevices.getUserMedia) {
      ...
      let onSuccess = function (stream) {
        ...
        mediaRecorder.onstop = function (event) {
          ...
          let file = new File([blob], "audio-command.ogg", {
            type: audioType,
          ...
          // uploadFile(file);
          commandAttachments.files = container.files;
          commandAttachments.dispatchEvent(new Event("change"));
        };
...
const uploadFile = (file) => {
  ...
  const input = document.getElementById("command_attachments");
  ...
  upload.create((error, blob) => {
    if (error) {
      ...
      commandForm.appendChild(hiddenField);
    }
  });
};
